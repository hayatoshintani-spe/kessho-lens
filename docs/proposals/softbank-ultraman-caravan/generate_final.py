...
add_table(s, Inches(0.7), Inches(1.55), Inches(11.9),
          ["", "内容", "費用(税別)"],
          [
              [("① 年間IP使用料(固定)", True), "イベント・イベントキット・店頭訴求ツール・LP/Web・SNSでのIP利用と作成物の監修対応を包括。着ぐるみイベントの開催権を含みます", ("2,000万円/年", True, RED)],
...
textbox(s, Inches(1.0), Inches(5.03), Inches(11.3), Inches(1.3), [
    ...
    ("・ステージショーをご希望の場合は年10回程度まで対応可能です(1回30万円〜・個別お見積り)", 12, INK, False),
], gap=5)
textbox(s, Inches(0.7), Inches(6.55), Inches(11.9), Inches(0.55), [
    ("※②は首都圏内は交通実費込みの特別条件、首都圏外は交通・宿泊実費を別途申し受けます。※控室(非公開の着替え場所)のご用意など、実施ルールの詳細は別紙レギュレーションをご参照ください。", 10, SUB, False),
], gap=3)
...
value_block(Inches(0.7), Inches(1.6), "1. 選べるヒーロー(8キャラクター)", [
    ...
    "(初代/セブン/ティガ/ダイナ/ゼロ/アーク/オメガ/テオ)",
    "季節・エリアごとの「キャラクター切替」で来店動機が持続します",
])
value_block(Inches(6.85), Inches(1.6), "2. 夏も稼働できる唯一の選択肢", [
...
value_block(Inches(6.85), Inches(3.9), "4. ヒーローショー水準の運用品質", [
    "専属ディレクター+スーツアクター2名体制・演技対応込み",
    "1回30分×1日最大5回・1回約50組の高い処理能力",
    "「空・宇宙」の世界観は通信サービスの訴求とも高い親和性",
])
...
textbox(s, Inches(0.7), Inches(6.25), Inches(11.9), Inches(0.8), [
    ...
    ("※②は土日2日間・ディレクター+アクター2名体制。首都圏内は交通実費込みの特別条件、首都圏外は交通・宿泊実費を別途申し受けます。", 10, SUB, False),
], gap=3)
