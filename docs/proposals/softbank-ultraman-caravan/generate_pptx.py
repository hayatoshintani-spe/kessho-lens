...
add_table(s, Inches(0.7), Inches(1.75), Inches(11.9),
          ...
          [
              ...
              ["ヒーロー登場・イベント運営費",
               "キャラクターショーの実勢価格(1回あたり数十万円+設営・音響・運営)をもとに、1施設あたり週末1〜2回の開催を想定して積算"],
              ["広告・送客費",
...
textbox(s, Inches(7.1), Inches(5.65), Inches(5.6), Inches(1.2), [
    ("※年間IP使用料8,000万円は、60周年プレミアム・ヒーロー稼働との一体運用・広範な使用範囲を含む年間包括契約想定の概算です。運営費・稼働枠は1施設あたり週末1〜2回の開催を想定して積算しています。", 10.5, SUB, False),
])
