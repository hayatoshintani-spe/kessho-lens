...
textbox(s, Inches(0.85), Inches(1.86), Inches(11.7), Inches(0.9), [
    ...
    [("SoftBankショップ、BB、でんき、モバイル相談へ送客する。", 15, INK, True),
     ("推奨は、FY27年度の年間活用を前提とした1.2億円プラン(B案)です。", 15, RED, True)],
], space_after=4)
bullets(s, Inches(0.85), Inches(3.15), Inches(11.8), Inches(3.6), [
    ...
    ("ご提案:A案3,500万円(短期検証)/B案1億2,000万円(FY27年間・推奨)/C案2億5,000万円(60周年大型展開)。", {"bold": True}),
], size=14, gap=12)
...
textbox(s, Inches(0.85), Inches(5.55), Inches(11.8), Inches(1.0), [
    [("ノベルティ設計:", 13.5, RED, True),
     ("作成数に上限を設けず、数量に応じた許諾対価を別途お支払いする設計を想定しています。", 13.5, INK, False)],
])
...
# =============================================================================
s = add_slide()
header(s, "3プラン比較", "推奨はB案:FY27標準プラン(1億2,000万円)です")
add_table(s, Inches(0.7), Inches(1.85), Inches(11.9),
          ["プラン", "金額(税別)", "位置づけ", "推奨度"],
          [
              ["A案:短期検証プラン", "3,500万円", "商業施設イベントの小規模検証(FY26下期パイロット)", "○"],
              [("B案:FY27標準プラン", True, RED), ("1億2,000万円", True, RED), ("年間展開の推奨案。FY27以降のリアル集客を補完", True, INK), ("◎", True, RED)],
...
# =============================================================================
s = add_slide()
header(s, "B案:FY27標準プラン|1億2,000万円(税別)【推奨】",
...
textbox(s, Inches(0.85), Inches(1.75), Inches(11.8), Inches(0.8), [
    ("B案の1億2,000万円は、IP使用料だけの金額ではありません。年間の企画・制作・イベント運営・店舗送客までを含む、実行費一式の総額です。", 14, INK, False),
], space_after=4)
items = [
