...
add_table(s, Inches(0.7), Inches(1.55), Inches(11.9),
          ...
          [
              [("最大(貴社実績同等・全量)", True), "600開催", "キット800式・ノベルティ4,000セット・ツール全店2回", "2,000万円", "1億2,000万円", "約3,570万円", ("約1.76億円", True, RED)],
              [("半分(実績の50%)", True), "300開催", "キット400式・ノベルティ2,000セット・ツール全店1回", "2,000万円", "6,000万円", "約1,790万円", ("約9,800万円", True, RED)],
              [("3IP分割(約1/3配分)", True), "200開催", "キット270式・ノベルティ1,300セット・ツール1/3", "2,000万円", "4,000万円", "約1,190万円", ("約7,200万円", True, RED)],
          ],
...
textbox(s, Inches(0.7), Inches(5.75), Inches(11.9), Inches(1.3), [
    [("継続パック(S1):", 12.5, RED, True),
     ("隔週(月2開催)190万円/月、毎週(月4開催)360万円/月(単発比の優遇設定)。スポットはIP使用料不要です。", 12.5, INK, False)],
    [("実施条件:", 12.5, RED, True),
