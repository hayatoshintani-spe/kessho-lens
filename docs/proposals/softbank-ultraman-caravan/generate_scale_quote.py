...
header(s, "規模別お見積り:3パターン(年間・税別概算)",
       "7/17お打ち合わせを受け、貴社実績同等・現実的・半分の3規模でご提示します(単価は共通:IP使用料2,000万円/着ぐるみ20万円/ロイヤリティ20%)")
add_table(s, Inches(0.7), Inches(1.55), Inches(11.9),
          ["パターン", "着ぐるみ", "キット・ノベルティ想定", "①IP使用料(固定)", "②着ぐるみ費用", "③ロイヤリティ", "年間合計"],
          [
              [("最大(貴社実績同等)", True), "600開催", "キット800式・ノベルティ4,000セット・ツール全店2回", "2,000万円", "1億2,000万円", "約3,570万円", ("約1.76億円", True, RED)],
              [("現実的(実績の75%)", True), "450開催", "キット600式・ノベルティ3,000セット・ツール全店2回", "2,000万円", "9,000万円", "約2,750万円", ("約1.38億円", True, RED)],
              [("半分(実績の50%)", True), "300開催", "キット400式・ノベルティ2,000セット・ツール全店1回", "2,000万円", "6,000万円", "約1,790万円", ("約9,800万円", True, RED)],
          ],
...
textbox(s, Inches(1.0), Inches(4.8), Inches(11.3), Inches(1.25), [
    ("お打ち合わせを受けた2つのご提案", 13, RED, True),
    ("・年間の最低開催数をお約束いただける場合、着ぐるみ単価を優遇します(例:400開催以上のコミットで17万円/開催)", 12.5, INK, False),
    ("・ウルトラマンは7・8月も稼働可能です(現行IP様は夏季稼働不可)。夏商戦を含むフル12か月稼働なら最大720開催まで拡張できます", 12.5, INK, False),
], gap=6)
textbox(s, Inches(0.7), Inches(6.25), Inches(11.9), Inches(0.8), [
    ("※③はキット単価15.5万円/式・ノベルティ9,900円/セットの現行水準で試算。作成単価は数量により変動するため、ロイヤリティは作成実績(実額)ベースで精算します。", 10, SUB, False),
    ("※ノベルティ・訴求ツールの年間実績数(貴社ご共有予定)を受領後、③を精緻化します。※固定費は①のみ。②③は実施・作成分だけの従量です。", 10, SUB, False),
], gap=3)
...
textbox(s, Inches(0.7), Inches(5.75), Inches(11.9), Inches(1.2), [
    [("実施条件:", 12.5, RED, True),
     ("当社の既存ライセンス条件の調整を経て、実施時期・会場を確定します(調整は当社にて速やかに進めます)。", 12.5, INK, False)],
    ("測定項目:来場数・撮影参加組数・ブース送客数を実測し、年間お見積りの開催数・KPI精緻化に活用します。", 12, INK, False),
    ("※通常イベントキットを用いるテストは、キット製作を伴うため来年度からのご提案とします。※本テスト費用は、年間ご契約成立時の扱い(充当等)を別途ご相談させてください。", 10.5, SUB, False),
], gap=5)
