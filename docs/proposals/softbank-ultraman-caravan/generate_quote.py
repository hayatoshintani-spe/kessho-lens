...
header(s, "ご参考:作成物の想定数量とロイヤリティ概算",
       "キット800式・ノベルティ約2.1万セット(FY25ご実績)に基づく試算です")
add_table(s, Inches(0.7), Inches(1.65), Inches(11.9),
          ...
          [
              ...
              ["ノベルティ", "約2.1万セット/年(FY25ご実績:約569万個)", "約8,800円/セット(実績)", "約1億8,500万円", "約3,700万円"],
              ["店頭訴求ツール(ポスター・POP・什器シート等)", "約3,000店×年2回更新", "約2,500円/店・回", "約1,500万円", "約300万円"],
              [("合計", True), "—", "—", ("約3.2億円", True), ("約6,480万円", True, RED)],
          ],
          col_widths=[1.5, 1.7, 1.1, 0.8, 0.9], row_h=0.62, font_size=11)
textbox(s, Inches(0.7), Inches(4.9), Inches(11.9), Inches(0.8), [
    ("※キットの数量・単価は貴社資料、ノベルティはFY25ご実績(年約2.1万セット・平均約8,800円/セット)に基づく参考値です。実際の作成計画に応じて変動し、お支払いは作成実績ベースの従量となります。", 11, SUB, False),
    ("※キット数は貴社ご提示の800式、ノベルティはFY25ご実績(作成費約1.85億円)を反映。店頭訴求ツールは作成数実績(年間約23.5万部)を受領済み・作成費実額のご共有後に精緻化します。", 11, SUB, False),
], gap=5)
...
add_table(s, Inches(0.7), Inches(1.65), Inches(11.9),
          ...
          [
              ...
              ["③ 作成許諾ロイヤリティ", "作成費用の20%", "キット800式・ノベルティ約2.1万セット(実績)・訴求ツール", "約6,480万円(従量)"],
              [("参考:年間合計(上記想定時)", True), "—", "—", ("約2.05億円", True, RED)],
          ],
...
textbox(s, Inches(1.0), Inches(1.9), Inches(11.3), Inches(2.0), [
    ...
    ("・年間IP使用料2,000万円+従量型(着ぐるみ20万円/開催・ロイヤリティ20%)のシンプルな3階建て構造", 13, INK, False),
    ("・ポケモン様の現行運用と同一の枠組み(形式・体制)のため、貴社・代理店様の運用フロー変更が不要", 13, INK, False),
