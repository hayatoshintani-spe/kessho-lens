...
add_table(s, Inches(0.7), Inches(1.65), Inches(11.9),
          ...
          [
              ["イベントキット(ゲームキット一式)", "約500キット(週400開催の同時稼働+予備・更新分)", "約15.5万円/キット", "約7,800万円", "約1,560万円"],
              ...
              [("合計", True), "—", "—", ("約1.3億円", True), ("約2,660万円", True, RED)],
          ],
...
add_table(s, Inches(0.7), Inches(1.65), Inches(11.9),
          ...
          [
              ...
              ["③ 作成許諾ロイヤリティ", "作成費用の20%", "キット約500・ノベルティ4,000セット・訴求ツール約3,000店×2回", "約2,660万円(従量)"],
              [("参考:年間合計(上記想定時)", True), "—", "—", ("約1.66億円", True, RED)],
          ],
