...
header(s, "ご参考:作成物の想定数量とロイヤリティ概算",
       "貴社資料の実績数量・単価(キット構成、ノベルティ4,000セット前提)に基づく参考試算です")
add_table(s, Inches(0.7), Inches(1.65), Inches(11.9),
          ["作成物", "想定数量(年間)", "単価目安(貴社資料より)", "作成費概算", "ロイヤリティ(10%)"],
          [
              ["イベントキット(ゲームキット一式)", "約500キット(週400開催の同時稼働+予備・更新分)", "約15.5万円/キット", "約7,800万円", "約780万円"],
              ["ノベルティ", "4,000セット(1セット=A〜D賞+参加賞327個、計約130万個)", "約9,900円/セット", "約4,000万円", "約400万円"],
              ["店頭訴求ツール(ポスター・POP・什器シート等)", "約3,000店×年2回更新", "約2,500円/店・回", "約1,500万円", "約150万円"],
              [("合計", True), "—", "—", ("約1.3億円", True), ("約1,330万円", True, RED)],
          ],
...
textbox(s, Inches(0.7), Inches(4.9), Inches(11.9), Inches(0.8), [
    ...
    ("※キット数は「週平均400開催の同時稼働に必要な流通数+消耗・デザイン更新分」として設定しています。", 11, SUB, False),
], gap=5)
...
add_table(s, Inches(0.7), Inches(1.65), Inches(11.9),
          ...
          [
              ...
              ["③ 作成許諾ロイヤリティ", "作成費用の10%", "キット約500・ノベルティ4,000セット・訴求ツール約3,000店×2回", "約1,330万円(従量)"],
              [("参考:年間合計(上記想定時)", True), "—", "—", ("約1.2億円", True, RED)],
          ],
